...
class AlwaysOnCustomView : View {
    ...
    private fun init(context: Context? = null) {
        ...
        when (prefs.get(P.USER_THEME, P.USER_THEME_DEFAULT)) {
            ...
            P.USER_THEME_JUNGLE, P.USER_THEME_WESTERN, P.USER_THEME_ANALOG -> {
                ...
                when (prefs.get(P.USER_THEME, P.USER_THEME_DEFAULT)) {
                    ...
                    P.USER_THEME_SAMSUNG -> {
                        ...
                        flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_MULTILINE_CLOCK] = true
                        flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_CAPS_DATE] = true
                    }
                    P.USER_THEME_SAMSUNG3 -> {
                        setFont(R.font.roboto_regular)
                        flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_SAMSUNG_3] = true
                    }
                    ...
                    P.USER_THEME_ANALOG -> {
                        setFont(R.font.roboto_regular)
                        flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_MULTILINE_CLOCK] = true
                        flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_ANALOG_CLOCK] = true
                    }
                }
            }
            ...
            P.USER_THEME_SAMSUNG2 -> {
                ...
                flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_SAMSUNG_2] = true
            }
        }
    ...
    private fun measureHeight(): Int {
        ...
        if (prefs.get(P.SHOW_CLOCK, P.SHOW_CLOCK_DEFAULT))
            currentHeight += padding16 + padding2 + getTextHeight(bigTextSize).run {
                if (flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_MULTILINE_CLOCK]) this * 2
                else this
            }
        if (prefs.get(P.SHOW_DATE, P.SHOW_DATE_DEFAULT)) {
            if (flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_SAMSUNG_3]) currentHeight =
                tempHeight + getTextHeight(bigTextSize) + padding16
            else currentHeight += getTextHeight(if (flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_BIG_DATE]) bigTextSize else mediumTextSize) + 2 * padding2
        }
        if (
    ...
    override fun onDraw(canvas: Canvas) {
        super.onDraw(canvas)
        relativePoint = if (flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_LEFT_ALIGN]) padding16.toFloat() else width / 2f
        currentHeight = 0f
        currentHeight += paddingTop
        ...
        val tempHeight = currentHeight
        if (prefs.get(P.SHOW_CLOCK, P.SHOW_CLOCK_DEFAULT)) {
            if (flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_ANALOG_CLOCK]) {
                ...
                canvas.drawRelativeText(
                    ...
                    if (flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_SAMSUNG_3]) -templatePaint.measureText(clockFormat.format(System.currentTimeMillis()))
        ...
        if (prefs.get(P.SHOW_DATE, P.SHOW_DATE_DEFAULT)) {
            ...
            canvas.drawRelativeText(
                dateFormat.format(System.currentTimeMillis()).run {
                    if (flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_CAPS_DATE]) this.uppercase()
                    else this
                },
                padding2,
                padding2,
                getPaint(
                    if (flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_BIG_DATE]) bigTextSize else mediumTextSize,
                    prefs.get(P.DISPLAY_COLOR_DATE, P.DISPLAY_COLOR_DATE_DEFAULT)
                ),
                if (flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_SAMSUNG_3]) templatePaint.measureText(dateFormat.format(System.currentTimeMillis()))
                    .toInt() / 2 + padding16 else 0
            )
            if (flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_SAMSUNG_3]) currentHeight =
                tempHeight + getTextHeight(bigTextSize) + padding16
        ...
        //Samsung 3 divider
        if (flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_SAMSUNG_3] && (prefs.get(
                P.SHOW_CLOCK,
        ...
        if (prefs.get(P.SHOW_BATTERY_ICON, P.SHOW_BATTERY_ICON_DEFAULT)
            ...
            canvas.drawVector(
                ...
                (relativePoint + (getPaint(mediumTextSize).measureText("$batteryLevel%")).run {
                    if (flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_LEFT_ALIGN]) this
                    else this / 2
                }).toInt(),
            ...
            canvas.drawRelativeText(
                ...
                if (flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_LEFT_ALIGN]) 0 else -drawableSize / 2
            )
        ...
        if (prefs.get(P.SHOW_MUSIC_CONTROLS, P.SHOW_MUSIC_CONTROLS_DEFAULT) && musicVisible) {
            skipPositions[0] = if (flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_LEFT_ALIGN]) relativePoint.toInt()
            else (relativePoint - getPaint(smallTextSize).measureText(musicString) / 2).toInt() - padding16
            skipPositions[1] =
                if (flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_LEFT_ALIGN]) (relativePoint + getPaint(smallTextSize).measureText(
                    musicString
                )).toInt() + drawableSize
                else (relativePoint + getPaint(smallTextSize).measureText(musicString) / 2).toInt() + padding16
            skipPositions[2] =
            ...
            canvas.drawRelativeText(
                ...
                if (flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_LEFT_ALIGN]) drawableSize else 0
            )
        }
        ...
        if (prefs.get(P.SHOW_NOTIFICATION_ICONS, P.SHOW_NOTIFICATION_ICONS_DEFAULT)) {
            try {
                ...
                val x: Int = if (flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_LEFT_ALIGN]) relativePoint.toInt()
                ...
                notificationIcons.forEachIndexed { index, icon ->
                    ...
                    if (flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_LEFT_ALIGN]) drawable.setBounds(
    ...
    private fun Canvas.drawVector(resId: Int, x: Int, y: Int, tint: Int) {
        ...
        if (vector != null) {
            vector.setTint(tint)
            if (flags[com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.FLAG_LEFT_ALIGN]) vector.setBounds(
                x,
                y - drawableSize / 2,
                x + drawableSize,
                y + drawableSize / 2
    ...
    fun startClockHandler() {
        ...
        updateHandler.postDelayed(object : Runnable {
            override fun run() {
                invalidate()
                updateHandler.postDelayed(this,
                    com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.UPDATE_DELAY
                )
            }
        },
            com.example.aoa.actions.alwayson.AlwaysOnCustomView.Companion.UPDATE_DELAY
